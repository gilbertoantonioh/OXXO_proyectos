# Plantilla de instrucciones para Copilot

applyTo: "./OXXO_PROYECTOS/**"
...
- Mensajes en inglés de ejecución y en castellano para traducción.
- Formato recomendado: `... (Debug Information: Module=&MODULE, Value Id=&VALUE_ID - &SQLERRM)`.
