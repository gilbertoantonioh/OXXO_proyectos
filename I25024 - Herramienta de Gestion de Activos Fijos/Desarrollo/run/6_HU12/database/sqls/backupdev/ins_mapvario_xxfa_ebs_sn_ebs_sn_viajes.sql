...
BEGIN
   ...
   xxfc_utl_pub_pkg.insertamapeo_prc(p_tipomapeo => 'XXFA_EBS_SN'
                                    ...
                                    ,p_salida4   => 'SELECT'
                                    ,p_salida5   => 'sn_trip_id,wst_trip_name,msi_item_description,msi_item_number,wdd_shipped_quantity,ooh_order_number,ooh_header_id,ool_line_id,ship_confirm_flag,wnd_confirm_date_yyyymmdd'
