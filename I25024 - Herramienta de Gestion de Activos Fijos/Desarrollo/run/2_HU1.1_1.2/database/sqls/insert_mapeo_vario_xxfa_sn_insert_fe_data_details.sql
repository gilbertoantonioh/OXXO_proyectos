SET DEFINE OFF
SET SERVEROUTPUT ON 
PROMPT INSERTA XXFC_MAPEOS_VARIOS XXFA_SN_INSERT_FE_DATA_DETAILS
...
BEGIN   
   ...
   WHERE  tipo_mapeo = 'XXFA_SN_INSERT_FE_DATA_DETAILS'
   ;
   
   xxfc_utl_pub_pkg.insertamapeo_prc(p_tipomapeo => 'XXFA_SN_INSERT_FE_DATA_DETAILS'
