   ...
   ********************************************************************************************/
	...
	BEGIN
		...
		ELSIF (NOT (((recinfo.DATA_DETAIL_ID = p_DATA_DETAIL_ID) OR (recinfo.DATA_DETAIL_ID IS NULL AND p_DATA_DETAIL_ID IS NULL))
				...
				AND ((recinfo.SN_U_FOLIO_VALIDACION_FACTURA = P_SN_U_FOLIO_VALIDACION_FACT) OR (recinfo.SN_U_FOLIO_VALIDACION_FACTURA IS NULL AND P_SN_U_FOLIO_VALIDACION_FACT IS NULL))
				AND ((recinfo.SN_U_TIPO_ERROR_FACTURA = p_SN_U_TIPO_ERROR_FACTURA) OR (recinfo.SN_U_TIPO_ERROR_FACTURA IS NULL AND p_SN_U_TIPO_ERROR_FACTURA IS NULL))
				...
				AND ((recinfo.SN_U_CLAVE_PRODUCTO_SAT = p_SN_U_CLAVE_PRODUCTO_SAT) OR (recinfo.SN_U_CLAVE_PRODUCTO_SAT IS NULL AND p_SN_U_CLAVE_PRODUCTO_SAT IS NULL))
				...
				AND ((recinfo.SN_U_TIPO_COMPROBANTE = p_SN_U_TIPO_COMPROBANTE) OR (recinfo.SN_U_TIPO_COMPROBANTE IS NULL AND p_SN_U_TIPO_COMPROBANTE IS NULL)))) THEN
			x_retcode := 2;
   ...
   ********************************************************************************************/
	...
	BEGIN
		lock_row(p_rowid
			...
			, p_XxfaSnDataDetails.OOL_LINE_ID
			...
			, p_XxfaSnDataDetails.SN_U_TIPO_ERROR_FACTURA
			...
			, p_XxfaSnDataDetails.SN_U_CLAVE_PRODUCTO_SAT
			...
			, p_XxfaSnDataDetails.SN_U_TIPO_COMPROBANTE
			, x_errors, x_retcode);
	END lock_row;
   ...
   ********************************************************************************************/
	...
	BEGIN
		...
		UPDATE XXFA_SN_DATA_DETAILS SET DATA_DETAIL_ID = DECODE(p_DATA_DETAIL_ID, FND_API.G_MISS_NUM, DATA_DETAIL_ID, p_DATA_DETAIL_ID)
			...
			, MSI_KIT_TYPE = DECODE(p_MSI_KIT_TYPE, FND_API.G_MISS_CHAR, MSI_KIT_TYPE, p_MSI_KIT_TYPE)
			, MSI_KIT_PRINCIPAL_FLAG = DECODE(p_MSI_KIT_PRINCIPAL_FLAG, FND_API.G_MISS_CHAR, MSI_KIT_PRINCIPAL_FLAG, p_MSI_KIT_PRINCIPAL_FLAG)
			, MSI_KIT_PARENT = DECODE(p_MSI_KIT_PARENT, FND_API.G_MISS_CHAR, MSI_KIT_PARENT, p_MSI_KIT_PARENT)
			...
			, FCB_ASSET_CATEG_ACCT = DECODE(p_FCB_ASSET_CATEG_ACCT, FND_API.G_MISS_CHAR, FCB_ASSET_CATEG_ACCT, p_FCB_ASSET_CATEG_ACCT)
			, FCB_ASSET_CATEG_SUBACCT = DECODE(p_FCB_ASSET_CATEG_SUBACCT, FND_API.G_MISS_CHAR, FCB_ASSET_CATEG_SUBACCT, p_FCB_ASSET_CATEG_SUBACCT)
			...
			, FAA_DESCRIPTION = DECODE(p_FAA_DESCRIPTION, FND_API.G_MISS_CHAR, FAA_DESCRIPTION, p_FAA_DESCRIPTION)
			, FBK_DATE_PLACED_MM = DECODE(p_FBK_DATE_PLACED_MM, FND_API.G_MISS_CHAR, FBK_DATE_PLACED_MM, p_FBK_DATE_PLACED_MM)
			, FBK_DATE_PLACED_YYYY = DECODE(p_FBK_DATE_PLACED_YYYY, FND_API.G_MISS_CHAR, FBK_DATE_PLACED_YYYY, p_FBK_DATE_PLACED_YYYY)
			, FAA_PROPERTY_TYPE_CODE = DECODE(p_FAA_PROPERTY_TYPE_CODE, FND_API.G_MISS_CHAR, FAA_PROPERTY_TYPE_CODE, p_FAA_PROPERTY_TYPE_CODE)
			...
			, PRL_ORACLE_CIA = DECODE(p_PRL_ORACLE_CIA, FND_API.G_MISS_CHAR, PRL_ORACLE_CIA, p_PRL_ORACLE_CIA)
			, PRL_ORACLE_EF = DECODE(p_PRL_ORACLE_EF, FND_API.G_MISS_CHAR, PRL_ORACLE_EF, p_PRL_ORACLE_EF)
			, PRL_RETEK_DISTRITO = DECODE(p_PRL_RETEK_DISTRITO, FND_API.G_MISS_NUM, PRL_RETEK_DISTRITO, p_PRL_RETEK_DISTRITO)
			, PRL_ORACLE_CR = DECODE(p_PRL_ORACLE_CR, FND_API.G_MISS_CHAR, PRL_ORACLE_CR, p_PRL_ORACLE_CR)
			, PRL_ORACLE_CR_DESCR = DECODE(p_PRL_ORACLE_CR_DESCR, FND_API.G_MISS_CHAR, PRL_ORACLE_CR_DESCR, p_PRL_ORACLE_CR_DESCR)
			...
			, PRL_ORACLE_CR_SUP_DESCR = DECODE(p_PRL_ORACLE_CR_SUP_DESCR, FND_API.G_MISS_CHAR, PRL_ORACLE_CR_SUP_DESCR, p_PRL_ORACLE_CR_SUP_DESCR)
			...
			, SN_U_ESTATUS_ASSETS = DECODE(p_SN_U_ESTATUS_ASSETS, FND_API.G_MISS_CHAR, SN_U_ESTATUS_ASSETS, p_SN_U_ESTATUS_ASSETS)
			, SN_U_ESTATUS_CONTABLE = DECODE(p_SN_U_ESTATUS_CONTABLE, FND_API.G_MISS_CHAR, SN_U_ESTATUS_CONTABLE, p_SN_U_ESTATUS_CONTABLE)
			, SN_U_ESTATUS_FACTURA = DECODE(p_SN_U_ESTATUS_FACTURA, FND_API.G_MISS_CHAR, SN_U_ESTATUS_FACTURA, p_SN_U_ESTATUS_FACTURA)
			, SN_U_FOLIO_VALIDACION_FACTURA = DECODE(P_SN_U_FOLIO_VALIDACION_FACT, FND_API.G_MISS_CHAR, SN_U_FOLIO_VALIDACION_FACTURA, P_SN_U_FOLIO_VALIDACION_FACT)
			, SN_U_TIPO_ERROR_FACTURA = DECODE(p_SN_U_TIPO_ERROR_FACTURA, FND_API.G_MISS_CHAR, SN_U_TIPO_ERROR_FACTURA, p_SN_U_TIPO_ERROR_FACTURA)
			, SN_U_FOLIO_SALIDA = DECODE(p_SN_U_FOLIO_SALIDA, FND_API.G_MISS_CHAR, SN_U_FOLIO_SALIDA, p_SN_U_FOLIO_SALIDA)
			, SN_U_SUBTOTAL = DECODE(p_SN_U_SUBTOTAL, FND_API.G_MISS_NUM, SN_U_SUBTOTAL, p_SN_U_SUBTOTAL)
			, SN_U_DESCUENTO = DECODE(p_SN_U_DESCUENTO, FND_API.G_MISS_NUM, SN_U_DESCUENTO, p_SN_U_DESCUENTO)
			, SN_U_IMPUESTO = DECODE(p_SN_U_IMPUESTO, FND_API.G_MISS_CHAR, SN_U_IMPUESTO, p_SN_U_IMPUESTO)
			, SN_U_RETENCIONES = DECODE(p_SN_U_RETENCIONES, FND_API.G_MISS_NUM, SN_U_RETENCIONES, p_SN_U_RETENCIONES)
			, SN_U_TOTAL = DECODE(p_SN_U_TOTAL, FND_API.G_MISS_NUM, SN_U_TOTAL, p_SN_U_TOTAL)
			, SN_U_CLAVE_PRODUCTO_SAT = DECODE(p_SN_U_CLAVE_PRODUCTO_SAT, FND_API.G_MISS_CHAR, SN_U_CLAVE_PRODUCTO_SAT, p_SN_U_CLAVE_PRODUCTO_SAT)
			, SN_UUID_FOLIO_STAT = DECODE(p_SN_UUID_FOLIO_STAT, FND_API.G_MISS_CHAR, SN_UUID_FOLIO_STAT, p_SN_UUID_FOLIO_STAT)
			, SN_USO_CFDI = DECODE(p_SN_USO_CFDI, FND_API.G_MISS_CHAR, SN_USO_CFDI, p_SN_USO_CFDI)
			, SN_U_MONEDA = DECODE(p_SN_U_MONEDA, FND_API.G_MISS_CHAR, SN_U_MONEDA, p_SN_U_MONEDA)
			, SN_U_TIPO_CAMBIO = DECODE(p_SN_U_TIPO_CAMBIO, FND_API.G_MISS_NUM, SN_U_TIPO_CAMBIO, p_SN_U_TIPO_CAMBIO)
			, SN_U_METODO_PAGO = DECODE(p_SN_U_METODO_PAGO, FND_API.G_MISS_CHAR, SN_U_METODO_PAGO, p_SN_U_METODO_PAGO)
			, SN_U_FORMA_PAGO = DECODE(p_SN_U_FORMA_PAGO, FND_API.G_MISS_CHAR, SN_U_FORMA_PAGO, p_SN_U_FORMA_PAGO)
			, SN_U_REGIMENT_FISCAL = DECODE(p_SN_U_REGIMENT_FISCAL, FND_API.G_MISS_CHAR, SN_U_REGIMENT_FISCAL, p_SN_U_REGIMENT_FISCAL)
			, SN_U_TIPO_COMPROBANTE = DECODE(p_SN_U_TIPO_COMPROBANTE, FND_API.G_MISS_CHAR, SN_U_TIPO_COMPROBANTE, p_SN_U_TIPO_COMPROBANTE)
   ...
   ********************************************************************************************/
	...
	BEGIN
		...
		INSERT INTO XXFA_SN_DATA_DETAILS(DATA_DETAIL_ID
			...
			, P_SN_U_FOLIO_VALIDACION_FACT
			, p_SN_U_TIPO_ERROR_FACTURA
			, p_SN_U_FOLIO_SALIDA
			, p_SN_U_SUBTOTAL
			, p_SN_U_DESCUENTO
			, p_SN_U_IMPUESTO
