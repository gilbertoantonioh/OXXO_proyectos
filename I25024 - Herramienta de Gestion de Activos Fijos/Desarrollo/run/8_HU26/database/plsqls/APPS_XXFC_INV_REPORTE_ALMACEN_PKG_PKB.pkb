...
/********************************************************************************************
  ...
  Modificado Por       Fecha              Codigo                 Descripción
--------------------------------------------------------------------------------------------
Daniel Vazquez     17/04/2017             CHG0113888            Creacion de funcion
   ...
   BEGIN
      ...
      BEGIN 
         FOR rec IN ( SELECT rcv.transaction_id AS rcv_transaction_id 
                      ...
                      --CHG0140503. Validar el origen de recepcion desde el perfil XXFC_RCV_FA_ORIGENES
      ...
      END;          
      --CHG0113888 HERNAGI: Fin 
	  
	  
      --CHG0140503 HERNAGI: Inicio 
